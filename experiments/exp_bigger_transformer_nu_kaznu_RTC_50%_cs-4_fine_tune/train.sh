...
--max-update 1500000 --dropout 0.3 --attention-dropout 0.1 --weight-decay 0.0 \
...
--restore-file  /mnt/s3-data/itmo/models/experiments/exp_bigger_transformer_all_data/checkpoint/m2m/checkpoint_last.pt 
